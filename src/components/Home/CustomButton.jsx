...
const CustomButton = () => {
  return (
    ...
    >
      ...
      <span className="inline-flex items-center justify-center w-full h-full px-5 py-3 text-base font-semibold text-white rounded-full cursor-pointer bg-slate-950 lg:text-2xl backdrop-blur-3xl">
        {HOME_GET_STARTED}{" "}
        <span>
